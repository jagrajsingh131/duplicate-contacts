// firebase.js (FORCE LONG POLLING FIX)
...
// ✅ KEY FIX: force Firestore to use long polling instead of streaming WebChannel
export const db = initializeFirestore(app, {
  experimentalForceLongPolling: true,
  useFetchStreams: true, // helps in strict environments
});
